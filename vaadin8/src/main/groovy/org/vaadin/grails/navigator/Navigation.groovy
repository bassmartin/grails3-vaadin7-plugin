...
class Navigation {
     ...
     *
     * @see {com.vaadin.v7.navigator.Navigator#navigateTo(java.lang.String)}
     *
     * @param path The path mapped to a {com.vaadin.v7.ui.UI}
     * @param fragment The fragment mapped to a {com.vaadin.v7.navigator.View}
     */
